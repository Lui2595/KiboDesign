<template>
    <div>
        <PageHeader
            :breadcrumb="[
                { title: 'Home', url: '' },
                { title: 'Politicas de Privacidad', url: '' },
            ]"
        />
            ...
            <div class="container">
                <div class="document">
                    ...
                    <div class="document__content typography">
                        <p>
                           El presente Política de Privacidad establece los términos en que Kibo Design usa y 
                           protege la información que es proporcionada por sus usuarios al momento de utilizar
                            ...
                            pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los términos 
                            de este documento. Sin embargo, esta Política de Privacidad puede cambiar con el tiempo o ser 
                       ...
                       <p>
                           ...
                           contacto como su dirección de correo electrónica e información demográfica. Así mismo cuando sea necesario
...
Kibo Design está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más 
avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.

                        </p>

                        <h3> Cookies  </h3>
                        <p>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse en su ordenador, al aceptar dicho fichero se crea y la cookie sirve entonces para tener información respecto al tráfico we. Otra función que tienen las cookies es que con ellas las webs pueden reconocerte individualmente y por tanto brindarte el mejor servicio personalizado de su web.
...
Kibo Design Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
