    ...
    <div>
        ...
        <div class="block faq">
            <div class="container">
                        ...
                        <div class="row">
                            <div class="faq__section-column col-12 col-lg-6">
                                <div class="typography">
                                    <h6>Que metodos de envio tienen disponible?</h6>
                                    ...
                                    <h6>Tienen envios internacionales?</h6>
                ...
                <div class="faq__section">
                    ...
                    <div class="faq__section-body">
                        <div class="row">
                            <div class="faq__section-column col-12 col-lg-6">
                                <div class="typography">
                                    <h6>Que metodos de paco tienen?</h6>
                            ...
                            <div class="faq__section-column col-12 col-lg-6">
                                <div class="typography">
                                    <h6>Que metodos de pago tienen?</h6>
                ...
                <div class="faq__section">
                    <div class="faq__section-title">
                        <h3>Ordenes y devoluciones</h3>
                    </div>
                    <div class="faq__section-body">
                        <div class="row">
                            <div class="faq__section-column col-12 col-lg-6">
                                <div class="typography">
                                    <h6>Cuando aplica devolucion??</h6>
                            ...
                            <div class="faq__section-column col-12 col-lg-6">
                                <div class="typography">
                                    <h6>Cuando no aplica devolucion?</h6>
