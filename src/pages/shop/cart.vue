                            ...
                            <tr v-for="item in cart.items" :key="item.id" class="cart-table__row">
                                ...
                                <td class="cart-table__column cart-table__column--product">
                                    ...
                                    <ul  class="cart-table__options">
                                        <li >
                                           Madera: {{item.product.variaciones.madera.nombre}} / Tela: {{item.product.variaciones.telas.nombre}} / Dimension: {{item.product.variaciones.dimensiones.nombre}} 
                                        </li>
                                    </ul>
                                </td>
...
import { state } from '~/store/compare'
...
export default class Page extends Vue {
    ...
    value:number=this.$store.state.cart.total;
