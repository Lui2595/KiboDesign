        ...
        <div class="container">
            <div class="order-success__body">
                ...
                <div class="order-success__meta">
                    <ul class="order-success__meta-list">
                        <li class="order-success__meta-item">
                            <span class="order-success__meta-title">Orden numero:</span>
                            <span class="order-success__meta-value">#{{ order.id }}</span>
                        </li>
                        <li class="order-success__meta-item">
                            <span class="order-success__meta-title">Creada a:</span>
                ...
                <div class="row mt-3 no-gutters mx-n2">
                    <div class="col-sm-16 col-12 px-2">
                        <AddressCard
                            :address="order.shippingAddress[0]"
                            badge="Dirección de envío"
                            :badge-muted="true"
                        />
                    </div>
...
export default class Page extends Vue {
    ...
    beforeMount(){
        shopApi.order(this.$route.params.id).then(response=>{
