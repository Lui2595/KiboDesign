<template>
    <div class="nav-links">
        <ul class="nav-links__list justify-content-around text-dark">
            <li
            ...
            >
                <AppLink class="nav-links__item-link" :to="item.url">
                     <img v-show="item === hoveredItem"  v-bind:src='item.icon2' alt="" 
                     style="
                     height: 28px;
                     width:  auto;
                     
                     "> 
                     <img v-show="item !==   hoveredItem" v-bind:src='item.icon' alt="" 
                     style="
                     height: 28px;
                     width:  auto;
