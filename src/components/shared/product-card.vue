<template>
    ...
    >
        ...
        <div v-if="product.discount" class="product-card__discount product-card__badge--sale text-center" >
            {{product.discount}}%
        </div>
        ...
        <div class="product-card__actions">
            ...
            <div class="product-card__send "  style="">
                
                    <div  class="text-center" style="  background-color: #ffcc29; display:flex; border: solid 2px #ccc;
padding: 1px;">
                        <Camion /> 
                        <span style="   margin-left:5px">  Entrega de 15 a 45 días  </span> 
                    </div>
...
import Camion from '~/svg/camion.svg'

export type ProductCardLayout = 'grid-sm' | 'grid-nl' | 'grid-lg' | 'list' | 'horizontal';

@Component({
    components: { AsyncAction, Quickview16Svg, AppLink, Rating, Wishlist16Svg, Compare16Svg ,Camion}
})
