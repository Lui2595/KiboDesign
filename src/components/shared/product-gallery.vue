    ...
    <div class="product__gallery">
        <div class="product-gallery">
            <div class="product-gallery__featured">
                ...
                <Carousel ref="featured" :options="featuredGalleryOptions" :autoplay="false">
            ...
            <div class="product-gallery__carousel">
                <Carousel ref="thumbnails" :options="thumbnailOptions" :autoplay="false">
                    <CarouselSlide v-for="(image, index) in images" :key="index" style="heigth:105px">
                        <a
                            :class="[
...
<style>
.product-gallery__carousel .swiper-container .swiper-wrapper .swiper-slide {
    width: 105px;
}
</style>