...
import nuxt_plugin_bootstrapvue_3350bfb4 from 'nuxt_plugin_bootstrapvue_3350bfb4' // Source: .\\bootstrap-vue.js (mode: 'all')
import nuxt_plugin_templatesplugindec018f6_77c4377c from 'nuxt_plugin_templatesplugindec018f6_77c4377c' // Source: .\\templates.plugin.dec018f6.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: function () {var _currentLanguage, _currentLanguage2;
    ...
    const options = {
      ...
      titleTemplate: function (titleChunk) {
        return titleChunk ? `${titleChunk} — kibo` : 'kibo';
      },
      htmlAttrs: {
        lang: (_currentLanguage = currentLanguage) === null || _currentLanguage === void 0 ? void 0 : _currentLanguage.locale,
        // Value of HTML dir attribute: <html dir="...">
        dir: (_currentLanguage2 = currentLanguage) === null || _currentLanguage2 === void 0 ? void 0 : _currentLanguage2.direction },
  ...
  if (typeof nuxt_plugin_bootstrapvue_3350bfb4 === 'function') {
    await nuxt_plugin_bootstrapvue_3350bfb4(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_templatesplugindec018f6_77c4377c === 'function') {
    await nuxt_plugin_templatesplugindec018f6_77c4377c(app.context, inject)
  }
